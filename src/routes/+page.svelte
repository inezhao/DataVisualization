...
<!--Shopping Bag-->
<svg width=800 height=600 style="background-color:#daebf1">
...
<text x={xPos- 115} y={yPos + heightSize*CategoryShare[0]/2} font-size={textSizeCategory}>{Type[0]}</text>
  ...
  style="fill:{AdvFill};stroke:{ArmsArmourStroke};stroke-width:{StrokeWidth};fill-opacity:{Opacity};stroke-opacity:0.9">
