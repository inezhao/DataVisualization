...
<svg {width} {height}>
    <g transform="translate({width/2}, {height/2})">
        <g transform="translate(0,-20)">
            ...
            <circle r=5 cx={width/2-150} cy={-height/2+50} fill='blue' opacity=0.5/>
            <text x={width/2-140} y={-height/2+55} font-size=20>2019</text>
            ...
            <circle r=5 cx={width/2-150} cy={-height/2+75} fill='red' opacity=0.5/>
            <text x={width/2-140} y={-height/2+80} font-size=20>2020</text>
            ...
            <circle r=5 cx={width/2-150} cy={-height/2+100} fill = 'green' opacity=0.5/>
            <text x={width/2-140} y={-height/2+105} font-size=20>2021</text>
            ...
            <circle r=5 cx={width/2-150} cy={-height/2+125} fill = 'purple' opacity=0.5/>
            <text x={width/2-140} y={-height/2+130} font-size=20>2021</text>
            ...
            <circle r=5 cx={width/2-150} cy={-height/2+150} fill = 'orange' opacity=0.5/>
            <text x={width/2-140} y={-height/2+155} font-size=20>2022</text>
        </g>

        <text x={-width/4-30} y={height/2-50} font-size=25 font-style="italic"> Number of orders throughout each year</text>
        <text x={-width/4-35} y={height/2-25} font-size=20 font-style="italic"> [Total number of orders for this category: {usedType.sum}]</text>
